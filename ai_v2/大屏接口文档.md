...
- [Socket.io 大屏接口文档](#socketio-大屏接口文档)
  ...
  - [4. 服务端广播消息](#4-服务端广播消息)
    ...
    - [4.2 分析状态广播](#42-分析状态广播)
      - [开合跳区域结果广播 (broadcast\_area\_result)](#开合跳区域结果广播-broadcast_area_result)
    - [4.3 分析结果广播](#43-分析结果广播)
    - [4.4 肢体远程控制状态广播](#44-肢体远程控制状态广播)
    - [4.5 广播身份信息](#45-广播身份信息)
    - [4.6 屏幕显示指定URL网页](#46-屏幕显示指定url网页)
    - [4.7 屏幕播放视频](#47-屏幕播放视频)
    - [4.8 屏幕播放音频](#48-屏幕播放音频)
    - [4.9 屏幕显示图片](#49-屏幕显示图片)
  - [5. 支持的体育项目](#5-支持的体育项目)
  - [6. 注意事项](#6-注意事项)
  - [7. 更新日志](#7-更新日志)
