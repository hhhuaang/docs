...
3. [发送消息](#3-发送消息)
   ...
   2. [ camera](#32-camera)
      ...
      3. [speak](#323-摄像头喊话)
      4. [goto](#324-摄像头转到预设角)
      5. [start_record](#325-开始录像)
      6. [stop_record](#326-停止录像)
      7. [frame](#327-截图)
   3. [ program ](#33-program)
      1. [start](#331-启动程序)
      2. [stop](#332-停止程序)
      3. [restart](#333-重启程序)
      4. [status](#333-已启动程序状态)
      5. [state](#334-程序状态)
4. [监听消息](#4-监听消息)
   ...
   5. [state_presets_camera](#45-state_presets_camera)
   6. [state_frame_camera](#46-state_frame_camera)
   7. [state_upload_record_camera](#45-state_upload_record_camera)
   8. [state_record_end_camera](#45-state_record_end)
   9. [state_start_record_camera](#45-state_start_record_camera)
