...
```
```json
{"action":"add_face","result":{"message":"添加成功","data":{"face_id":13981,"user_id":1,"feat":null,"image_path":"/face_images/1_1747277059007.jpg"}},"cameraid":"3","roomid":"714f0f34-cb94-492a-86f6-2b0a4548b047"}
```
```json
{"action":"add_face","result":{"detail":"图片中没用人脸"},"cameraid":"3","roomid":"714f0f34-cb94-492a-86f6-2b0a4548b047"}
```
