...
### 3.2. add_face （上传图片分辨率需要控制在640*640内，过大的图片会导致socket.io离线）（即将废弃，管理脸库请查看脸库-wss服务文档）
...
### 4.5. add_face_camera （上传图片分辨率需要控制在640*640内，过大的图片会导致socket.io离线）（即将废弃，管理脸库请查看脸库-wss服务文档）
